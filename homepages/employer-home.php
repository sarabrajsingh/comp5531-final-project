    ...
    <div class="row">
      <div class="col-md-3 ">
        <div class="list-group ">
          ...
          <a href="#" class="list-group-item list-group-item-action">Create a Job Offer</a>
              ...
              <div class="col-md-8">
                <form id="saveJobForm" action="post-job.php" method="post" role="form" style="display: block;">
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input id="jobName" name="jobName" placeholder="Enter Job Title here" class="form-control here" type="text">
                    </div>
                  </div>
                  ...
                  <input id="addCustomJob" name="addCustomJob" placeholder="Optional - Enter Job Title to Add" class="form-control here" type="text">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input id="lowerSalaryAmount" name="lowerSalaryAmount" placeholder="Lower Salary Amount" class="form-control here" type="number">
                      <input id="upperSalaryAmount" name="upperSalaryAmount" placeholder="Upper Salary Amount" class="form-control here" type="number">
                    </div>
                  </div>
                  <div class="form-group row">
